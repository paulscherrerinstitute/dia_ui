 ...
 * @memberof Vaadin
 */
class GridProEditSelectWrapperElement extends PolymerElement {
  static get template() {
    return html`
    <vaadin-grid-pro-edit-select id="selectEditor" value="{{value}}" theme="grid-pro-editor" on-keydown="_onSelectKeydown" on-focusout="_onSelectFocusout"></vaadin-grid-pro-edit-select>
`;
  }
